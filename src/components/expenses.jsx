        ...
        >
          ...
          >
            ...
            <div style={{ color: "white", marginTop: 10 }}>
              ...
              <p style={{ fontSize: 14, color: "#FAFAFA", margin: 0 }}>April 2022</p>
              <h4 style={{ margin: 0 }}>$20,129</h4>
            </div>
          </div>
          <div
            className="border"
          ...
          >
            ...
            <div style={{ marginTop: 10 }}>
              ...
              <p style={{ fontSize: 14, color: "#AAAAAA",margin: 0 }}>April 2022</p>
              <h4 style={{ color: "#4EB7F2",margin: 0 }}>$20,129</h4>
            </div>
          </div>
          <div
            className="border"
